...
import {
  ...
  FiltroIngresos,
} from '../features/ingresos/models/ingresos.model';
...
export class IngresosService {
  ...
  crear(input: IngresoInput): Observable<IngresoResponse> {
    return this.http.post<IngresoResponse>(this.apiUrl, input, {
  ...
  listar(filtro: FiltroIngresos = {}): Observable<IngresosListResponse> {
    ...
    return this.http.get<IngresosListResponse>(this.apiUrl, {
      params,
      withCredentials: true,
    });
  }
  ...
  obtenerPorId(id: string): Observable<{ ingreso: Ingreso }> {
    return this.http.get<{ ingreso: Ingreso }>(`${this.apiUrl}/${id}`, {
      withCredentials: true,
    });
  }

  actualizar(id: string, input: IngresoInput): Observable<IngresoResponse> {
    return this.http.put<IngresoResponse>(`${this.apiUrl}/${id}`, input, {
      withCredentials: true,
    });
  }
